...
<!--<link href="<?= asset($assets . '/lte2/dist/css/skins/_all-skins.min.css') ?>" rel="stylesheet" type="text/css">-->
    ...
    <link href="<?= asset($assets . '/plugins/daterangepicker/daterangepicker-bs3.css') ?>" rel="stylesheet"
          type="text/css"/>
...
<!-- Left side column. contains the logo and sidebar -->
    ...
    <div class="content-wrapper" style="min-height: 209px">
        <div class="content-header">
            <h1>
                <span style="color: #605ca8"
                      class="{{ isset($navigation->getCurrentPage()['icon']) ? $navigation->getCurrentPage()['icon'] : 'fa fa-hashtag' }}"></span>&nbsp;{{ $title }}
